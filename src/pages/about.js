  ...
  render() {
    ...
    return (
      ...
      <div className="flex flex-col md:flex-row items-center">
        ...
        <a href="/eagles" className="text-white text-center no-underline font-bold py-2 px-4 mx-1 my-1 w-48 rounded bg-bsa-blue hover:bg-blue-900 object-right">Eagle Scouts</a>
        ...
        <a href="/leaders" className="text-white text-center w-48 no-underline font-bold py-2 px-4 mx-1 my-1 rounded bg-bsa-blue hover:bg-blue-900 object-right">Adult Leadership</a>
