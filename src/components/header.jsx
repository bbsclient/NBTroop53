      ...
      <div className="flex flex-wrap items-center justify-between max-w-4xl mx-auto p-4 md:p-8">
        <Link to="/" className="flex items-center no-underline text-white">
          <svg
            ...
            width="54"
            height="54"
            viewBox="0 0 29.82 33.83"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              d="M13.866 33.006c-.925-1.005-1.668-2.454-2.043-3.24-1.827.831-3.473-.049-3.548-.09l.014.007c-1.825-.932-2.421-2.431-2.612-3.523-.437-2.503.519-3.759.519-3.759s.877 4.156 3.915 2.169l.641.472c-.073.037-1.785 2.034-4.157.203.044 1.024.471 2.655 2.163 3.52l.007.003.007.004c.059.032 1.52.795 3.016-.155l.512-.325.238.558c.011.025.904 2.098 1.974 3.352.149.172.336.276.336.276.069-.034.297-.27.297-.27 1.072-1.253 1.969-3.334 1.979-3.359l.238-.558.512.325c1.497.95 2.957.187 3.017.155l.006-.004.007-.003c1.693-.865 2.119-2.496 2.164-3.52-2.373 1.832-4.084-.166-4.157-.203l.641-.472c3.038 1.987 3.915-2.169 3.915-2.169s.956 1.256.519 3.759c-.19 1.092-.787 2.591-2.611 3.523l.014-.007c-.075.041-1.722.921-3.548.09-.368.772-1.13 2.244-2.033 3.249 0 0-.466.512-.958.815-.003.001-.474-.273-.984-.823z"
              fill="white"
            />
            ...
            <path
              fill="white"
              d="M3.177 16.117l.404 1.162 1.23.026-.98.743.356 1.179-1.01-.704-1.01.703.356-1.178-.981-.743 1.231-.026zM14.881 3.064s.207 3.884.344 5.225c0 0 .138 2.131.172 3.438h-1.134s.207-2.509.275-3.438c0 0 .206-2.922.343-5.225z"
            />
            <path
              d="M1.353 14.162c-1.035 4.016 1.259 6.054 2.465 6.817.28-1.875 2.002-2.856 2.097-2.905l.851.607c-2.771 1.445-1.867 3.928-1.867 3.928s-2.201-.9-3.323-2.214C-1.141 17.212.453 13.543.579 13.27l.774.892zM27.047 17.279l-.404-1.162-.404 1.162-1.231.026.981.743-.356 1.179 1.01-.704 1.01.703-.356-1.178.981-.743z"
              fill="white"
            />
